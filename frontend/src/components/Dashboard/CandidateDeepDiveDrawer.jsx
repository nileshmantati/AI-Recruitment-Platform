                                ...
                                {statusChoices.map(s => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-3.5 py-1.5 rounded-lg! text-[14px]! font-semibold uppercase tracking-wider border cursor-pointer shadow-2xs hover:shadow-sm active:scale-[0.98] transition-all ${isSelected ? s.bg : 'bg-slate-100 text-slate-700 border-slate-300'
