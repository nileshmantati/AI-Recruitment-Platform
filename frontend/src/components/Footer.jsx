...
const Footer = () => {
    return (
        <footer className="relative bg-slate-950 pt-16 pb-4 text-slate-300 border-t border-slate-800/60 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-5 lg:gap-8">
                    ...
                    {[
                        ...
                        <div key={col.title}>
                            <h4 className="mb-5 text-xl! font-semibold! text-slate-50 uppercase tracking-wider">{col.title}</h4>
                            <ul className="space-y-3 ps-0 text-sm text-slate-400">
                                {col.links.map((l) => (
                                    <li key={l}>
                                        <a href="#" className="inline-block transition-all text-decoration-none duration-200 text-white! hover:text-blue-400! hover:translate-x-1">
                                            {l}
                                        </a>
                                    </li>
                                ))}
                ...
                <div className="mt-16 flex flex-col gap-4 items-center justify-between border-t border-slate-800/80 pt-6 sm:flex-row">
