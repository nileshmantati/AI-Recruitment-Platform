...
const Hero = () => {
    ...
    return (
        <section className="relative overflow-hidden py-12 sm:py-16 md:py-20 lg:py-28" style={{ background: `radial-gradient(1200px 600px at 50% -10%, ${T.primary}14, transparent), radial-gradient(800px 500px at 90% 10%, ${T.secondary}14, transparent)` }}>
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 text-center">
                <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white px-3 py-2 text-xs sm:text-sm font-medium shadow-sm" style={{ color: T.primary }}>
                ...
                <p className="mx-auto mt-6 sm:mt-8 max-w-3xl text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-slate-600">
                ...
                <div className="mt-8 sm:mt-10 md:mt-12 flex flex-wrap items-center justify-center gap-4">
                    <PrimaryButton className="px-5 py-3 text-sm sm:text-base rounded-xl" onClick={() => navigate("/login")}>
