...
const StepCard = ({ s }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mb-6 text-4xl! font-extrabold! transition-transform duration-300 group-hover:scale-110 group-hover:translate-x-1" style={{ color: `${T.primary}30` }}>{s.n}</div>
        ...
        <section className="py-28" style={{ background: T.bg }}>
            <div className="mx-auto max-w-7xl px-6">
                <div className="mx-auto mb-16 max-w-2xl text-center">
                    ...
                    <h2 className="mt-4 text-4xl! font-extrabold! text-slate-900">Hire in four simple steps</h2>
                </div>
