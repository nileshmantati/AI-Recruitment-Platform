...
export const TextField = ({ icon: Icon, label, type = "text", placeholder, rightIcon, onRightClick, ...props }) => {
    ...
    return (
        <div className="mb-2">
            ...
            <div
                ...
                style={{ borderColor: focused ? T.primary : "#E2E8F0", boxShadow: focused ? `0 0 0 4px ${T.primary}1A` : "none" }}
            >
