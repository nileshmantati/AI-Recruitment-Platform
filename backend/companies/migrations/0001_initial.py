        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True,
                 null=True, upload_to='company/logos/')),
                ('cover_banner', models.ImageField(
                    blank=True, null=True, upload_to='company/banners/')),
                ...
                ('working_mode', models.CharField(blank=True, choices=[
                 ('REMOTE', 'Remote'), ('HYBRID', 'Hybrid'), ('ONSITE', 'Onsite')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='ai_preferences', to='companies.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_color', models.CharField(
                    default='#0f172a', max_length=7)),
                ('secondary_color', models.CharField(
                    default='#3b82f6', max_length=7)),
                ('theme', models.CharField(default='light', max_length=20)),
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='branding', to='companies.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('doc_type', models.CharField(choices=[('GST', 'GST Certificate'), ('PAN', 'PAN'), (
                    'REG', 'Registration Certificate'), ('ISO', 'ISO Certificate'), ('OTHER', 'Other')], max_length=10)),
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='documents', to='companies.company')),
            ],
        ),
        migrations.CreateModel(
            name='CompanyGallery',
            fields=[
                ...
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='gallery_images', to='companies.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='locations', to='companies.company')),
            ],
        ),
        migrations.CreateModel(
            name='CompanySocial',
            fields=[
                ...
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='socials', to='companies.company')),
            ],
        ),
    ]
