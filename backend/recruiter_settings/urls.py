...
urlpatterns = [
    ...
    path('integrations/', views.IntegrationSettingsView.as_view(), name='integration_settings'),
    path('appearance/', views.AppearanceSettingsView.as_view(), name='appearance_settings'),
