...
from .views import ApplyJobView, GenerateInterviewQuestionsView, JobApplicantsListView, UpdateApplicationStatusView, ScheduleInterviewView, MyApplicationsListView, LatestApplicationsView
